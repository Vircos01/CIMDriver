...
abstract class AppDatabase : RoomDatabase() {
	...
	companion object {
        ...
        val MIGRATION_30_31 = object : Migration(30, 31) {
            override fun migrate(db: androidx.sqlite.db.SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE trips ADD COLUMN expectedDistanceMeters INTEGER DEFAULT NULL")
            }
        }

        val MIGRATION_31_32 = object : Migration(31, 32) {
            override fun migrate(db: androidx.sqlite.db.SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE classification_rules ADD COLUMN startAddress TEXT DEFAULT NULL")
                db.execSQL("ALTER TABLE classification_rules ADD COLUMN endAddress TEXT DEFAULT NULL")
            }
        }
