...
This document provides a systematic overview of the current main source files in `app/src/main`. It is intended as a reference for developers who want to quickly see which components are present in the codebase.
